...
<!-- --A -->  
<div class="flex flex-col h-screen  || bg-colorTourq">
<!-- --B -->    
    <nav class='  lg:p-2.5  lg:gap-2.5 || w-full bg-colorBlack text-colorWhite flex flex-col  font-sansita py-2 space-y-2  lg:text-2xl bg-cover bg-center bg-no-repeat' style="background-image: url('/storage/pictures/banner.png');">
                
                <div class='  || flex flex-row md:justify-end lg:px-[60px]  justify-between px-[40px] py-[10px] gap-2 mr-2'>
                    @auth
                    <a href='{{ route('profile') }}' class='p-2 lg:p-2.5  bg-colorPink text-colorWhite hover:text-colorWhite hover:bg-[#cc706f] font-sansita text-[13px] lg:text-2xl font-extrabold rounded-md self-center max-w-max uppercase'>Perfil</a>
                    <p class="hidden md:block self-center">|</p>

                    <a class='p-2 lg:p-2.5   bg-colorPink text-colorWhite hover:text-colorWhite hover:bg-[#cc706f] font-sansita text-[13px] lg:text-2xl font-extrabold rounded-md self-center max-w-max uppercase'
                        onclick="event.preventDefault();
                        document.getElementById('logout-form').submit();">
                        {{ __('Cerrar Sesión') }}
                    </a>
                    ...
                    <a href='{{ route('register') }}' class='p-2 lg:p-2.5  bg-colorPink text-colorWhite hover:text-colorWhite hover:bg-[#cc706f] font-sansita text-[13px] lg:text-2xl font-extrabold rounded-md self-center max-w-max uppercase'>
                    Registrarse </a>
                    <p class="hidden md:block self-center">|</p>                
                    <a href='{{ route('login') }}' class='p-2 lg:p-2.5   bg-colorPink text-colorWhite hover:text-colorWhite hover:bg-[#cc706f] font-sansita text-[13px] lg:text-2xl font-extrabold rounded-md self-center max-w-max uppercase'>
                    Iniciar Sesión</a> 
                
                    @endguest
                </div>

                <div class=' border-colorGreen border-2 text-center || w-full lg:gap-[155px] flex flex-row'>
        
                    <div class='border || w-full flex items-center justify-center'>
                        <a href='#' class='  || p-2   text-colorPink hover:text-[#E37383]  font-sansita text-[24px] lg:text-[40px] font-extrabold  self-center max-w-max uppercase'>
                            Que ofrecemos
                        </a>
                    </div>
                    ...
                    <div class='border || w-full flex justify-center items-center'>
                        <a href='{{ route('home') }}' class='  flex justify-center items-center bg-colorPink rounded-full w-[90px] h-[90px] md:w-[140px] md:h-[140px] lg:w-[200px] lg:h-[200px] drop-shadow-lg animate-bounce'>
                            <div class=' || w-[80px] h-[80px] md:w-[130px] md:h-[130px] lg:w-[336px] lg:h-[360px] bg-cover bg-center bg-no-repeat' style="background-image: url('/storage/pictures/logo.svg');"></div>
                        </a>
                    </div>
                ...
                <div class=' py-2.5 pr-2.5 || flex justify-center space-x-[25px]'>
                    
                    <a class='p-2.5  bg-colorPink text-colorWhite hover:text-colorWhite hover:bg-[#cc706f] font-sansita text-[13px] lg:text-2xl font-extrabold rounded-md self-center max-w-max uppercase'>
                        Contacto
                    </a>

                    <a id="button-header" href='{{ route('events.index') }}' class='p-2.5  bg-colorPink text-colorWhite hover:text-colorWhite hover:bg-[#cc706f] font-sansita text-[13px] lg:text-2xl font-extrabold rounded-md self-center max-w-max uppercase'>
                        Evento
                    </a>
                </div>
    </nav>
<!-- --C -->       
        <main class="flex  justify-center min-w-full  border-colorGreen border container || bg-colorPink">
            @yield('content')
        </main>
<!-- --C -->
