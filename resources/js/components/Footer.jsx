...
const Footer = () => {
    ...
    <div class="flex max-w-full justify-between space-x-9 bg-colorBlack p-9 | text-colorWhite font-sansita font-bold text-base">
    <!-- Contact Info -->
   <section class="flex space-x-9 ">
    ...
    <!-- SocialMedia -->
    <div class="  self-center fit flex space-x-6">
      <section class="bg-colorGreen self-center h-fit  ">
      ...
      <section class=" bg-colorGreen place-self-center   ">
    ...
    <!-- Collarobators -->
    <div class="h-fit space-x-1.5 flex  border-colorPink self-center    ">
      <section class="">
