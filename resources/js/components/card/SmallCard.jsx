...
<>
    <section className=" h-fit  max-w-max flex flex-col gap-[10px] font-extrabold font-sansita text-colorBlack bg-colorWhite rounded-[10px]   ">
        ...
        <button className=" tracking-[0.20em] h-fit py-4 px-[69px]  font-librefranklin font-bold text-[24px] bg-colorYellow rounded-bl-[10px] rounded-br-[10px]  text-colorWhite text-2xl">
        DESAPUNTAR
        </button>
    </section>
        </>
