...
const BigCard = () => {
  ...
  return (
    <div className='flex w-full md:w-5/12  flex-row shadow border-1 border-[#929191] rounded-lg'>
      ...
      <div className='w-full card flex flex-col gap-3 font-sansita'>
        ...
        <div>
          <p className='w-full text-sm md:text-xl truncate_text'>{event.description} </p><a href='#' className='text-colorTourq text-sm md:text-xl'>Ver mas</a>
        </div>
      </div>
    </div>
  )
